...
SOURCE_PATH='./dva_aspekta' # название папки, в которой лежат варианты, которые нужно сравнить с каноническим
CANON='./dva_aspekta_kanon.txt' # название файла, в котором лежит канонический текст
        ...
        for j in l2.split():
            if i == j:
                ...
                if len(common_s(i,j))!=0:
                    ...
                    #print 'LEN COMMONS is', len(common_s(i,j))
                    if len(common_s(i,j)) >= 4: # or (len(i) - len(common_s(i,j))<2):
                        ...
                        #<font color="CC00FF">[diff]
                        newii = re.sub(u'<r></r>', u'<r><font color="CC00FF">[diff]</font></r>', newii)
                        same += newii + '\n'
                        #l1 = ' '.join(l1)
